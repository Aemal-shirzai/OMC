					...
					<div class="btn float-right" id="shareBtn" data-toggle="tooltip" title="more options">
						...
						<div class="shareOptions" id="shareOptions-{{$question->id}}">
							...
							<span title="Delete Post">
								<li>
									<a href="javascript:void(0)" id="postDeleteOption-{{$question->id}}" class="PostEditDelete"  data-toggle="modal" data-target="#deleteBox" data-id="{{$question->id}}" data-type="listQuestions"><span class="fas fa-trash"></span> <Span id="postDeleteText-{{$question->id}}">Delete</Span></a>
								</li>
							</span>
							@endif
							@endauth
